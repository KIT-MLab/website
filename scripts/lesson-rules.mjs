...
export const LIMITS = {
  ...
  bodyMax: 800,
  /** 第4.1節 「説明」の要素。
      下限は 2026-09-24 に 250 から 100 に下げた（第0章と同じ）。第8章・練習編・第9章と3回続けて、
      書き手が 250 に届かせるために文を足していた。下限は足りない説明を厚くせず、要らない文を足させる */
  explainMin: 100,
  explainMax: 600,
...
export const BANNED = [
  ...
  /* プログラミングでは見かけない言い方（20-platform.md 第18.4節）。「書き方」「習ったこと」などに言い換える */
  { re: /道具/, label: '道具', group: '曖昧化' },
  // 読者の知識の仮定
